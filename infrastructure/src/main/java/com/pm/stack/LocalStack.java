...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        DatabaseInstance authServiceDb =
                createDatabases("AuthServiceDB", "auth-service-db");

        DatabaseInstance patientServiceDb =
                createDatabases("PatientServiceDB", "patient-service-db");
        ...
        FargateService authService =
                createFargateService(
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "9f4c8d7b2a1e6f3c8b5d0a7e1f9c4b6d2a8e5f7c1b3d9a6e4c2f8b7d1a5e9c3")
                );
    ...
    private DatabaseInstance createDatabases(String id, String dbName) {
